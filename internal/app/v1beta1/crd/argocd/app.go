...
func specToValues(imageTags map[string]string, spec *toolsetsv1beta1.Argocd, namespace string) *Values {
...
func defaultValues(imageTags map[string]string) *Values {
	values := &Values{
		...
		Configs: &Configs{
			KnownHosts: &Data{
				Data: map[string]string{"ssh_known_hosts": `|
